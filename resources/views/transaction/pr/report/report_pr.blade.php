...
<body>
    ...
    <table class="table-stepper">
        ...
        <tbody>
        @forelse ($logProduct as $item)
           
            <tr>
                <td>{{$item->itemRelation->name}}</td>
                <td style="text-align: center">{{$item->quantity}}</td>
                <td style="text-align: center">{{$item->quantity_request}}</td>
                <td style="text-align: center">{{$item->quantity_final}}</td>
                <td style="text-align: center">{{$item->itemRelation->uom}}</td>
            </tr>
