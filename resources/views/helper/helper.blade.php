        ...
        function mappingTableItem(response,id){
            var data =''
                ...
                $('#'+id).DataTable().destroy();
                        ...
                        {
                            if(response[i].request_code == null || response[i].request_code== undefined){
                                data += `
                                        <tr style="text-align: center;">
                                            <td style="width:5%">${i + 1}</td>
                                            <td style="text-align:left; width:60%;">${response[i].item_name}</td>
                                            ...
                                            <td style="text-align:right; width:10%;">${response[i].quantity_result}</td>
                                            <td style="text-align:center; width:5%;">${response[i].uom}</td>
                                        </tr>
                                `
                            }else{
