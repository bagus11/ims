                 ...
                 <div class="container">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-3 mt-2">
                                    ...
                                    <span style="font-size:11px" id="assignment_transaction_code"></span>
                                </div>
                                ...
                                <div class="col-md-3 mt-2">
                                    <span style="font-size:11px" id="assignment_location_id"></span>
                                </div>
                                <div class="col-md-3 mt-2">
                                    <span style="font-size:11px">Destination Location</span>
                                </div>
                                <div class="col-md-3 mt-2">
                                    <span style="font-size:11px" id="assignment_des_location"></span>
                                </div>
                                <div class="col-md-3 mt-2">
                                    <span style="font-size:11px">Status</span>
                                </div>
                                <div class="col-md-3 mt-2">
                                    <span style="font-size:11px" id="assignment_status"></span>
                                </div>
                                <div class="col-md-3 mt-2">
                                    <span style="font-size:11px">User</span>
                                </div>
                                <div class="col-md-9 mt-2">
                                    <span style="font-size:11px" id="assignment_user_id"></span>
                                </div>
                                <div class="col-md-3 mt-2">
                                    <span style="font-size:11px">Current Approval</span>
                                </div>
                                <div class="col-md-9 mt-2">
                                    <span style="font-size:11px" id="assignment_approval_id"></span>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-9 mt-2">
                                    <textarea name="assignment_remark" class="form-control" disabled id="assignment_remark"></textarea>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                    <fieldset class="scheduler-border">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-11">
                                <table class="datatable-bordered nowrap display" id="assignment_item_table">
                                    <thead>
                                        <tr>
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-2">
                                <select name="select_assign_approval" class="form-select" style="font-size:11px;padding:5px;width:100%" id="select_approval">
