...
<body>
    ...
    <h2>Code 419</h2>
    <div id="jail" onclick="window.location('/')">
    ...
    <!--     thank you https://stackoverflow.com/posts/15496546/revisions -->
        ...
        <text x="0" y="0" text-anchor="left" style="font-size:90pt;">
            <textPath xlink:href="#textPath" startOffset="0%" >MOUSE JAIL</textPath><textPath xlink:href="#textPath" startOffset="50%" >MOUSE JAIL</textPath>
        </text>
      </svg>
      <div id="cursor"></div>
    </div>
