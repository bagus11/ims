    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <b class="headerTitle">Edit Type</b>
            ...
            <div class="modal-body">
               <div class="container">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" id="initial_edit">
                            <span  style="color:red;" class="message_error text-red block initial_edit_error"></span>
                        </div>
                    </div>
