            ...
            <div class="modal-body p-0 mx-2 mt-2">
                ...
                <div class="row mb-2">
                    <div class="col-2 offset-8">
                        <input type="date" id="from" class="form-control" value="{{ date('Y-m-d', strtotime('-1 month')) }}">
                    </div>
                    <div class="col-2">
                                        ...
                                        <table class="datatable datatable-bordered" id="in_table" style="font-size:9px">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th rowspan="2" style="text-align:center; padding: 0 10px;">Request Code</th>
                                                    <th rowspan="2" style="text-align:center; padding: 0 10px;">Item Name</th>
                                                    <th rowspan="2" style="text-align:center; padding: 0 10px;">Location</th>
                                                    <th rowspan="2" style="text-align:center; padding: 0 10px;">Destination Location</th>
                                                    <th colspan="3" style="text-align:center; padding: 0 10px;">Quantity</th>
                                                    <th rowspan="2" style="text-align:center; padding: 0 10px;">UOM</th>
                                                    <th rowspan="2" style="text-align:center; padding: 0 10px;">PIC</th>
                                                </tr>
                                                <tr>
                                                    <th>Before</th>
                                                    <th>Request</th>
