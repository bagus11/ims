    ...
    // Operation
        // Add
            $('#btn_add_approver').on('click', function(){
                ...
                $('#select_category').append('<option> Choose Department First</option>')
            })
        ...
        // Edit Step
            $('#approver_table').on('click', '.detail', function(){
                ...
                getCallback('detailMasterApproval',data,function(response){
                    swal.close()
                    $('#edit_department').val(response.detail.category_relation.department_relation.name)
                    $('#edit_category').val(response.detail.category_relation.name)
            ...
            var data=''
                    for(i = 0; i < response.length; i++ )
                    {
                        data += `<tr style="text-align: center;">
                                ...
                                <td style="text-align:left;">${response[i].category_relation == null ? '' :response[i].category_relation.name}</td>
